...
final class AboutYouViewController: BaseViewController {
    ...
    private let ageData: [Int] = MeasurementsData.age.values as! [Int]
    
    private let weightData: [Int] = MeasurementsData.weight.values as! [Int]
    
    private let heightData: [Int] = MeasurementsData.height.values as! [Int]
    
    private let genderData: [String] = MeasurementsData.gender.values as! [String]
    ...
    override func bindViewModel() {
        ...
        self.viewModel.outputs.nextButtonState
            ...
            .observeValues { [weak self] in
                ...
                self?.nextButton.backgroundColor = $0 ? AppStyle.Colors.darkGreen : UIColor.lightGray
        }
